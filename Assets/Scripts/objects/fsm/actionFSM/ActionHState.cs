...
{
    [Serializable]
    public abstract class ActionHState : ActionState, IFSM
    {
        /// <summary>
        ...
        /// </summary>
        private Dictionary<Type, ActionState> _states = new Dictionary<Type, ActionState>();
        public Dictionary<Type, ActionState> States { get => _states; }
